...
import (
	...
	sap_api_input_reader "sap-api-integrations-warehouse-available-stock-reads/SAP_API_Input_Reader"
	"sap-api-integrations-warehouse-available-stock-reads/config"
...
func main() {
	...
	inputSDC := fr.ReadSDC("./Inputs/SDC_Warehouse_Availabe_Stock_Header_sample.json")
	...
	caller.AsyncGetWarehouseAvailableStock(
		inputSDC.WarehouseAvailableStock.EWMWarehouse,
		inputSDC.WarehouseAvailableStock.Product,
		accepter,
	)
}
