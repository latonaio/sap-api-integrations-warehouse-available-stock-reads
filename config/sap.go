...
func newSAP() *SAP {
	return &SAP{
		...
		tokenRefreshURL: getEnv("SAP_TOKEN_REFRESH_URL", "http://XXX.XX.XX.XXX:8080/sap/opu/odata/sap/api_whse_availablestock/srvd_a2x/sap/warehouseavailablestock/0001/"),
